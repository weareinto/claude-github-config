---
name: start
description: Guided 4-step pre-implementation gate — verify ticket exists, status is Ready, create linked branch, move card to In progress. Run before any code changes. Uses weareinto, claude-github-config, 22 — substituted at install time.
---
...
' -F org="weareinto" -F repo="claude-github-config" -F number=<ISSUE_NUMBER>
